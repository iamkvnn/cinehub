...
export class UpdateDirectorDto extends OmitType(DirectorDto, ['createdAt', 'updatedAt', 'deletedAt', 'photoUrl']) {}

export class CreateDirectorDto extends OmitType(UpdateDirectorDto, ['id']) {}