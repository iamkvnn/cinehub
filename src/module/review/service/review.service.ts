...
export class ReviewService {
    ...
    async find(filmId: string, query: PaginatedApiQuery): Promise<[Review[], number]> {
    ...
    async findOne(id: string): Promise<Review> {
        const entity = await this.repository.findOne({ where: { id }, relations: ['author'] });
        if (!entity) {
    ...
    async update(userId: string, id: string, dto: UpdateReviewDto): Promise<Review> {
